...
The product acquisition type describes the purpose of the acquisition. It is similar to the `acquisitionType` field from the
[OGC® Earth Observation Metadata profile of Observations & Measurements](https://docs.ogc.org/is/10-157r4/10-157r4.html#24),
Table 5, property `acquisitionType`:
